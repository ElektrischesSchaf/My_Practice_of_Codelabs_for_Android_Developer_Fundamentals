...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("Yee 1:   ",marketPref);

        String chose_the_delivery_show=sharedPref.getString("example_list_2","Same day messenger service");
        Log.d("Yee 2:   ",chose_the_delivery_show);


        displayToast(marketPref+chose_the_delivery_show);
    }
