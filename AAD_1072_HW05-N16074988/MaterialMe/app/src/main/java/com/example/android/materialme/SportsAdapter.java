...
class SportsAdapter extends RecyclerView.Adapter<SportsAdapter.ViewHolder>  {
    ...
    class ViewHolder extends RecyclerView.ViewHolder
        ...
        public void onClick(View view) {
            ...
            //ImageView mSportsImage = itemView.findViewById(R.id.sportsImage);
            pair[0]=new Pair<View, String>(mSportsImage,"profile");
            Log.d("Transition","Transition profile");
            ActivityOptions options=ActivityOptions.makeSceneTransitionAnimation((Activity) mContext, pair);

            //Intent i=new Intent(MainActivity.class,DetailActivity.class);
